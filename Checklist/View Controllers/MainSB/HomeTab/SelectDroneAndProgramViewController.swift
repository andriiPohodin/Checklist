        ...
        Checklist(drones: [
                    Drone(name: .xagXp2020, availableScenarious: [
                            Scenario(mappingSource: .xrtk4, sections: [
                                        ...
                                        Section(sectionTitle: .quickStartGuideSectionTitle, sectionDescription: .quickStartGuideSectionDescription, sectionContent: [QuickStartGuideSectionContent.wechat, .miniProgram, .xagAgri, .activation, .roleDistribution, .pairingACB1, .pairingMobileStation, .pairingRover, .pairingXP2020]),
                            ...
                            Scenario(mappingSource: .xmission, sections: [
                                        Section(sectionTitle: .inTheBoxSectionTitle, sectionDescription: .inTheBoxSectionDescription, sectionContent: [InTheBoxSectionContent.xp2020, .b13860s, .cm12500, .xrtk, .acb1, .alr6]),
                                        Section(sectionTitle: .quickStartGuideSectionTitle, sectionDescription: .quickStartGuideSectionDescription, sectionContent: [QuickStartGuideSectionContent.wechat, .miniProgram, .xagAgri, .xGeomatics, .activation, .roleDistribution, .pairingACB1, .pairingMobileStation, .pairingXP2020]),
                                        Section(sectionTitle: .indoorSectionTitle, sectionDescription: .indoorSectionDescription, sectionContent: [IndoorSectionContent.weatherForecastCheck, .equipmentSetupCheck]),
